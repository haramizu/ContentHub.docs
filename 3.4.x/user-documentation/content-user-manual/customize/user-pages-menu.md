...
6. 受信したい電子メールまたはリアルタイム通知のタイプを選択します。リアルタイム通知。
...
速度テストを実行したい場合は、**スタートテスト**ボタン <img src="../../../images/user-documentation/content-user-manual/customize/user-page-menu-340-11-speedtest-start-button.png" /> をクリックしてテストを完了させます。
